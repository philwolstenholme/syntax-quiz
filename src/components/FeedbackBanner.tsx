...
const CountdownButton = ({
  ...
  return (
    <button
      ...
      aria-label={
        paused
          ? `Resume timer (${Math.ceil((1 - progress) * 100)}% remaining)`
          : `Pause timer (${Math.ceil((1 - progress) * 100)}% remaining)`
      }
      aria-pressed={paused}
    >
      <div
            ...
            {lastAnswer.skipped ? (
              <>
                ...
                <span>
                  ...
                  <DocsLink
                    term={lastAnswer.term}
                    href={lastAnswer.docsLink}
