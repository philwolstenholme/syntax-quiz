...
export const level1Questions: Question[] = [
  ...
  },
  {
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals#string_interpolation"
  },
  {
  ...
  return \`Hello, \${name}!\`;
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/Default_parameters"
  },
  {
  ...
  return numbers.reduce((a, b) => a + b, 0);
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/rest_parameters"
  },
  {
...
const last = colors.pop();`,
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/pop"
  },
  {
...
numbers.push(4);`,
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/push"
  },
  {
...
const upper = text.toUpperCase();`,
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/toUpperCase"
  },
  {
    code: `function greet(name: string) {
  return \`Hello, \${name}!\`;
...
greet('Alice');`,
  ...
  return a + b;
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/function"
  },
  {
...
console.log(fruits[0]);`,
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array#accessing_array_elements"
  },
  {
  ...
  },
  {
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Object_initializer"
  },
  {
...
const message = isActive ? 'yes' : 'no';`,
  ...
  },
  {
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/find"
  },
  {
...
console.log(selectedUser, cachedValue);`,
  ...
  },
  {
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/some"
  },
  {
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/every"
  },
  {
...
export const level2Questions: Question[] = [
  ...
  return 'Alice';
    ...
    docsLink: "https://www.typescriptlang.org/docs/handbook/2/everyday-types.html#return-type-annotations"
  },
  {
...
const name = user?.profile?.name;`,
  ...
  return input ?? 'default';
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Nullish_coalescing"
  },
  {
  ...
  bark() {
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Objects/Classes_in_JavaScript#inheritance"
  },
  {
...
var x = 5;`,
  ...
  return data;
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise"
  },
  {
...
const numbers = [1, 2, 3].map(double);`,
  ...
  },
  {
    ...
    explanation: "`Array.reduce()` processes each element through a callback, accumulating a single result. It doesn't return a new array (that's `map()` or `filter()`), a boolean (that's `some()` or `every()`), or the first match (that's `find()`). The first argument `acc` is the accumulator that carries the running total, and `0` is the initial value.",
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/reduce"
  },
  {
  ...
  return value.toFixed(2);
    ...
    explanation: "A type guard is a runtime check that narrows a variable's type within a conditional block. After `typeof value === 'string'`, TypeScript knows `value` is a `string` inside the `if` block. A type assertion (`as string`) forces the type without checking — a type guard proves it. 'Type cast' is terminology from other languages; TypeScript doesn't have true casts.",
...
const style = { [field]: 'blue' };`,
    ...
    explanation: "A computed property name uses `[expression]` in an object literal to evaluate the key at runtime. It's not an index signature (`[key: string]: type`), which defines a type contract for any string key in an interface. Destructuring extracts values from objects — it doesn't create them. 'Dynamic key' describes the concept informally, but the official term is computed property name.",
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Object_initializer#computed_property_names"
  },
  {
...
for (const fruit of fruits) {
  console.log(fruit);
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/for...of"
  },
  {
    code: `function Timer() {
...
title ||= 'Untitled';`,
    ...
    options: ["logical OR assignment", "nullish assignment", "default assignment", "fallback operator"],
    ...
    docsLink: "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Logical_OR_assignment"
  },
];
...
type Result = ToArray<'a' | 'b' | 42>;`,
    ...
    docsLink: "https://www.typescriptlang.org/docs/handbook/2/conditional-types.html#distributive-conditional-types"
  },
  {
    code: `type Shape =
