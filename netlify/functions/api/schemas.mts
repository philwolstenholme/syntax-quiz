...
export const FeedbackSchema = z.object({
  ...
  pointsEarned: z
    ...
    .int()
    .min(0)
    .describe("Points earned for this answer (0 if wrong or skipped)"),
});
...
export const ProgressSchema = z.object({
  ...
  questionsRemaining: z
    .number()
    .int()
    .min(0)
    .describe("Number of questions left to answer in this pass"),
  isRetryRound: z
    .boolean()
    .describe("True if this is a retry round for previously missed questions"),
});
